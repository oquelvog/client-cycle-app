  ...
  return (
    <div className="flex flex-col h-full bg-white border-l border-gray-200">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
        ...
        />
        <h2 className="font-semibold text-gray-900 flex-1 truncate">{client.name}</h2>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="bg-gray-50 rounded-lg p-2">
            ...
            <p className={cn("text-xs font-semibold", pct === 100 ? "text-green-600" : pct > 0 ? "text-amber-600" : "text-gray-600")}>
          ...
          <div className="bg-gray-50 rounded-lg p-2">
            <p className="text-[10px] text-gray-400 uppercase tracking-wide mb-0.5">Last Contact</p>
        ...
        {checkIns.length > 0 && (
          <div>
            ...
            <div className="space-y-3">
              {checkIns.map((ci) => (
                <div key={ci.id}>
                  <p className="text-xs text-gray-500 font-medium mb-1.5">{ci.title}</p>
                    ...
                    {ci.tasks.map((task) => {
                      ...
                      return (
                        <div key={task.id} className="flex items-center gap-2">
                          ...
                          <span className={cn("text-xs", done ? "line-through text-gray-400" : "text-gray-700")}>
                            {task.title}
                          </span>
                        </div>
                      );
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full text-sm border border-gray-200 rounded-lg p-2.5 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400"
          />
          {notesDirty && (
            <button
